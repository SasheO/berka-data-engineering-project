...
CREATE TABLE IF NOT EXISTS {{ params.db_schema }}.src_demographic_district (
    ...
    region String,
    num_inhabitants Int64 default -1,
    num_municipalities_less_499 Int64 default -1,
    num_municipalities_500_1999 Int64 default -1,
    num_municipalities_2000_9999 Int64 default -1,
    num_municipalities_gt_10000 Int64 default -1,
    num_cities Int64 default -1,
    urban_ratio Float32 default -1,
    average_salary Float32 default -1,
    unemployment_rate_95 Float32 default -1,
    unemployment_rate_96 Float32 default -1,
    entrepreneurs_per_1000 Int64 default -1,
    num_crimes_95 Int64 default -1,
    num_crimes_96 Int64 default -1
